function New-LogonScriptContent {
    ...
    .DESCRIPTION
        ...
        via scheduled task as SYSTEM or as the current user (WDAGUtilityAccount), and captures the exit code.
    .PARAMETER Params
...
# register script as scheduled task running as current user
