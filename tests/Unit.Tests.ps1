Describe "CHECK CONFIGURATION FILES ARE PRESENT" {
	...
	$Files = ('intunewin-Box-icon.ico', 'IntuneWinAppUtil.exe', 'IntuneWinAppUtilDecoder.exe', 'Invoke-IntunewinUtil.ps1', 'Invoke-Test.ps1', 'New-ToastNotification.ps1', 'sandbox.ico', 'sandbox_detection.ico', 'toast.xml')
